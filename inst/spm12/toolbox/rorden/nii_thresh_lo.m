function nii_thresh_lo (P, Thresh);
%Values less than Thresh (and NaNs) are set to zero
%   nii_thresh_lo('C:\dir\img.nii');
% Example - all values less than 0.5 are set to 0.0
%   nii_thresh_lo('C:\dir\img.nii', 0.5);
