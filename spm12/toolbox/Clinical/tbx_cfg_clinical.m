...
MRnormseg.val     = {anat les t2 clinicalTemplate clean bb vox ssthresh DelIntermediate};
...
CTnorm.val     = {images ctles brainmaskct bb vox DelIntermediate};
...
MRnorm.val     = {anat les t2 modality brainmask bb vox DelIntermediate};
