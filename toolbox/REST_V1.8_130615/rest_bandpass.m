...
for iCut=1:CUTNUMBER
    ...
    AllVolume(:,Segment) = rest_IdealFilter(AllVolume(:,Segment), ASamplePeriod, [AHighPass_LowCutoff, ALowPass_HighCutoff]);
...
rest_Write4DNIfTI(AllVolumeBrain,Header_Out,sprintf('%s_filtered%sFiltered_4DVolume.nii', ADataDir, filesep));
