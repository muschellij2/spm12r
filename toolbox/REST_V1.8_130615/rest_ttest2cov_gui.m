function varargout = rest_ttest2cov_gui(varargin)
%   varargout = rest_ttest2cov_gui(varargin)
%   Two-Sample T-Test GUI.
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rest_ttest2cov_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rest_ttest2cov_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function rest_ttest2cov_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rest_ttest2cov_gui_OutputFcn(hObject, eventdata, handles)
...
if lenC(1) >=2
    msgbox('Only two groups are allowed in Two-Sample T-Test.','Warning');
else
...
lenC=size(handles.Cfg.CovariateDirs);
if lenC(1) >=2
    msgbox('Only two group of covariate images are allowed in Two-Sample T-Test.','Warning');
else
...
if lenC(1) >=2
    msgbox('Only two text covariates files are allowed in Two-Sample T-Test.','Warning');
else
...
uimenu(handles.hContextMenu, 'Label', 'Remove selected group', 'Callback', 'rest_ttest2cov_gui(''DeleteSelectedG'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenu, 'Label', '=============================');
uimenu(handles.hContextMenu, 'Label', 'Remove all data groups', 'Callback', 'rest_ttest2cov_gui(''ClearG'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rest_ttest2cov_gui(''DeleteSelectedIC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rest_ttest2cov_gui(''ClearIC'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rest_ttest2cov_gui(''DeleteSelectedOC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rest_ttest2cov_gui(''ClearOC'',gcbo,[], guidata(gcbo))');
