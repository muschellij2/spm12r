function [DegreeCentrality_PositiveWeightedSumBrain, DegreeCentrality_PositiveBinarizedSumBrain, Header] = rest_DegreeCentrality(AllVolume, rThreshold, OutputName, MaskData, IsNeedDetrend, Band, TR, TemporalMask, ScrubbingMethod, ScrubbingTiming, Header, CUTNUMBER)
...
rest_WriteNiftiImage(DegreeCentrality_PositiveWeightedSumBrain,Header,OutputName_PositiveWeightedSumBrain);
rest_WriteNiftiImage(DegreeCentrality_PositiveBinarizedSumBrain,Header,OutputName_PositiveBinarizedSumBrain);

% rest_writefile(DegreeCentrality_NegativeWeightedSumBrain,[pathstr, filesep ,name, '_DegreeCentrality_NegativeWeightedSumBrain', ext],BrainSize,VoxelSize,Header, 'single');
% rest_writefile(DegreeCentrality_NegativeBinarizedSumBrain,[pathstr, filesep ,name, '_DegreeCentrality_NegativeBinarizedSumBrain', ext],BrainSize,VoxelSize,Header, 'single');
