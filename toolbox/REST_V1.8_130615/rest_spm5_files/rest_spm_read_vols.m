function [Y,XYZ] = rest_spm_read_vols(V,mask)
...
% Andrew Holmes
% $Id: spm_read_vols.m 1096 2008-01-16 12:12:57Z john $
...
if mask
	...
	for i=1:n, im(i)=~rest_spm_type(V(i).dt(1),'NaNrep'); end
	%-Mask
	Y(Y(:,:,:,im)==0)=NaN;
end
