...
dir = '/Volumes/Mac_Data/contravbm'; %location of images
...
for i=1:n   
    ...
    nii_mrnorm (T1i,Lsi,T2i, true, [1 1 1],[-78 -112 -50; 78 76 85], false, 0.005, 2);  
...
for i=1:hn   
    ...
    fprintf('Unified segmentation of %s, job %d/%d\n', T1i, i, hn);
    nii_mrnorm (T1i,'','', true, [1 1 1],[-78 -112 -50; 78 76 85], false, 0.005, 2);  
end; %for i : each image
